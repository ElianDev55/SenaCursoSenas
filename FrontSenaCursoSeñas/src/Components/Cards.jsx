...
export const Cards =  (data) => {
  ...
  >
    ...
    >
      ...
      onClick={() => {  contextVideos.handleOpen(); contextVideos.fetchVideoData(data.data.idvideo) } }
      >
        <Image
          isBlurred
          alt="Album cover"
      ...
      <CardFooter className="h-100 max-h-100 p-4 flex justify-between items-center">
        <div className="flex items-center">
          {data.data.idvideo ? (
            <Tooltip key="bottom" placement="bottom" content="Eliminar video" color="danger">
        ...
        <div>
          <Tooltip key="bottom" placement="bottom" content="Actualizar video" color="primary">
